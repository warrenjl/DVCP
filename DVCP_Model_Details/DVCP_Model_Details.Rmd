...
* Spherical (h_model = 4):  $h\left(\left\|\textbf{s}_i - \textbf{p}\right\|; \lambda, \eta\left\{a_p\left(\textbf{s}_i\right)\right\}\right) = 1 - 1.5 \frac{\left\|\textbf{s}_i - \textbf{p}\right\|}{\lambda\exp\left[\eta\left\{a_p\left(\textbf{s}_i\right)\right\}\right]} + 0.5\left(\frac{\left\|\textbf{s}_i - \textbf{p}\right\|}{\lambda\exp\left[\eta\left\{a_p\left(\textbf{s}_i\right)\right\}\right]}\right)^3$;
